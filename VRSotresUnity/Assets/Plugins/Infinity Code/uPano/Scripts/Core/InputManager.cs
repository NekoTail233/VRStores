...
namespace InfinityCode.uPano
{
    ...
    public static class InputManager
    {
        ...
        /// </summary>
        public static Func<float> OnGetAxis;

        /// <summary>
        /// Intercept getting key
        /// </summary>
        public static Func<bool> OnGetKey;

        /// <summary>
        /// Intercept getting mouse button
        /// </summary>
        public static Func<bool> OnGetMouseButton;

        /// <summary>
        /// Intercept getting mouse button down
        /// </summary>
        public static Func<bool> OnGetMouseButtonDown;

        /// <summary>
        /// Intercept getting mouse button up
        /// </summary>
        public static Func<bool> OnGetMouseButtonUp;

        /// <summary>
        /// Intercept getting touche
        /// </summary>
        public static Func<Touch> OnGetTouch;
        ...
        {
            if (OnGetAxis != null) return OnGetAxis();
        ...
        {
            if (OnGetKey != null) return OnGetKey();
        ...
        {
            if (OnGetMouseButton != null) return OnGetMouseButton();
        ...
        {
            if (OnGetMouseButtonDown != null) return OnGetMouseButtonDown();
        ...
        {
            if (OnGetMouseButtonUp != null) return OnGetMouseButtonUp();
        ...
        {
            if (OnGetTouch != null) return OnGetTouch();
